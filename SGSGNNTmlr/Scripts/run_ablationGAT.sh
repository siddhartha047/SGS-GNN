...
for mode in "learned"; do
    ...
    #for dataset in "SmallCora" "Cora" "CiteSeer" "johnshopkins55" "Squirrel" "Roman-empire"; do
        ...
        for GNN in "GAT"; do
            ...
            for edgeGNN in "MLP" "GCN" "GSAGE"; do
                echo ----EdgeGNN---$edgeGNN------
                python main.py --dataset $dataset --mode learned --runs 3 --epochs 200 --save_csv True --edge_mlp_type $edgeGNN --GNN $GNN --log False --sparse_edge_mlp True --conditional False --reg1 True --reg2 True
