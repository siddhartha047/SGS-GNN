...
python main.py --dataset $dataset --mode learned --runs 5 --epochs 500 --save_csv True --edge_mlp_type $edgeGNN --GCN GCN --log False --sparse_edge_mlp True --conditional True --reg1 True --reg2 True --nhid 64 --eval True --convergence 0.001 --pipeline "${PIPELINE}"
python main.py --dataset $dataset --mode learned --runs 5 --epochs 500 --save_csv True --edge_mlp_type $edgeGNN --GCN GCN --log False --sparse_edge_mlp True --conditional False --reg1 True --reg2 True --nhid 64 --eval True --convergence 0.001 --pipeline "${PIPELINE}"
