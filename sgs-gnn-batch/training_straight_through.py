...
# Training function with alternating updates (straight-through pipeline)
    ...
    for batch in cluster_loader:
        ...
        if mode == 'learned':
            ...
            if batch.edge_index.shape[1] > q:                                          
                ...
                # pass 2: sample sparse subgraph using edge probs            
                t_init = args.t_init 
                t_min = args.t_min
                ...
                # use sampled-edge weights directly (straight-through gradients)
                learned_out = model(batch, sampled_edge_index, sampled_edge_weight)
                edge_probs_for_loss = sampled_edge_weight
